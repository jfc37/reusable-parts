...
import { isRegisteringSelector, hasRegisteredSelector, registerErrorMessageSelector } from '@reusable-parts/register-page/src/+state/register.selectors';
...
export class RegisterPageComponent implements OnInit, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    this.registrationSucceeded$.pipe(
