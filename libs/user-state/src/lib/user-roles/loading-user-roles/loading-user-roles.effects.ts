...
export class LoadingUserRolesEffects {
  ...
  loadAll$ = this.actions$.pipe(
    ...
    exhaustMap(() =>
      this.repository.getAllUserRoles().pipe(
  ...
  @Effect()
  getByRoleReset$ = this.actions$.pipe(
  ...
  @Effect()
  getByRoleLoad$ = this.actions$.pipe(
    ofType<GetUserRolesByRole>(LoadingUserRolesActionTypes.GetByRole),
    withLatestFrom(
  ...
  @Effect()
  loadByRole$ = this.actions$.pipe(
    ofType<LoadUserRolesByRole>(LoadingUserRolesActionTypes.LoadByRole),
    mergeMap(action =>
      this.repository.getUserRolesByRole(action.role).pipe(
