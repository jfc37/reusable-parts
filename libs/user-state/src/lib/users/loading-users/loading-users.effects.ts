...
export class LoadingUsersEffects {
  ...
  loadAll$ = this.actions$.pipe(
    ...
    mergeMap(() =>
      this.repository.getAllUsers().pipe(
  ...
  load$ = this.actions$.pipe(
    ...
    mergeMap(action =>
      this.repository.getUser(action.id).pipe(
