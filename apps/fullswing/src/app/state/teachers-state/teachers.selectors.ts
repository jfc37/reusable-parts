...
export const isLoadingTeachersSelector = isLoadingUserRolesSelectorFn(
  FullSwingRoleTypes.Teacher
);

export const hasLoadingTeachersErroredSelector = hasLoadingUserRolesErroredSelectorFn(
  FullSwingRoleTypes.Teacher
);
